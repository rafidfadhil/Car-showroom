                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h4 class="modal-title">CAR RENTAL PORTAL</h4>
                                    </div>
                                    <div class="modal-body">
                                        <iframe src="https://www.youtube.com/embed/tqlXomr0Vik" width="560" height="300"
                                            allow="autoplay" frameborder="0"></iframe>
                                        <p>Jaringan kami masih terus berkembang. Saat ini, kami beroperasi di kota
                                            Bandung dan segera kami akan menyebarkan pinjaman mobil ke seluruh kota.
                                            car rental portal ada di sini untuk membantu anda yang membutuhkan mobil
                                            dengan cara meminjam nya,
                                            . Ini adalah layanan Pinjaman mobil berdasarkan
                                            permintaan.
                                            Jangan khawatir. Milikmu
                                            mobil akan berada di tangan tim yang berpengalaman dan profesional untuk
                                            melakukan servisrutin.
                                        </p>
                                    </div>
                                </div>
                                <?php } }?>
